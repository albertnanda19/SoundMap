...
// Config holds all configuration for the geo-index service
type Config struct {
	GRPCPort          int    `envconfig:"GRPC_PORT" default:"50054"`
	MetricsPort       int    `envconfig:"METRICS_PORT" default:"8084"`
	...
	ServiceName       string `envconfig:"SERVICE_NAME" default:"geo-index"`
	ServiceVersion    string `envconfig:"SERVICE_VERSION" default:"0.1.0"`
	LogLevel          string `envconfig:"LOG_LEVEL" default:"info"`
	CacheExpirySeconds int   `envconfig:"CACHE_EXPIRY_SECONDS" default:"30"`
