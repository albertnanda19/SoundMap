...
// Config holds all configuration for the alert-engine service
type Config struct {
	GRPCPort       int    `envconfig:"GRPC_PORT" default:"50053"`
	MetricsPort    int    `envconfig:"METRICS_PORT" default:"8083"`
	...
	ServiceName    string `envconfig:"SERVICE_NAME" default:"alert-engine"`
